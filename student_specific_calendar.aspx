<%@ Page Title="" Language="C#" MasterPageFile="~/MP/StudentMasterPage.master" AutoEventWireup="true" CodeFile="student_specific_calendar.aspx.cs" Inherits="student_specific_calendar" %>
        ...
        $(document).ready(function () {
            ...
            $('#calendar').fullCalendar({
                ...
                events: function (event) {
                    ...
                    getTigburbyID.id = $.cookie('UserName');
